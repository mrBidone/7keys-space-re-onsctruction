        ...
        o !== void 0 &&
          ...
          (_(i[a]) && _(s[a])
            ? s[a].__swiper__
              ...
              : O(i[a], s[a])
            : !_(i[a]) && _(s[a])
            ? ((i[a] = {}), s[a].__swiper__ ? (i[a] = s[a]) : O(i[a], s[a]))
            : (i[a] = s[a]));
      }
    }
  }
    ...
    if (
      ...
      if (t.slidesPerView === "auto") {
        ...
        if (
          ...
          C = i.isHorizontal() ? ce(E, "width") : ce(E, "height");
        else {
          const L = e(P, "width"),
            k = e(P, "padding-left"),
          ...
          if (le && le === "border-box") C = L + ne + oe;
            ...
            const { clientWidth: Pe, offsetWidth: Me } = E;
...
function Ye(i) {
  ...
  for (let o = 0; o < s.length; o += 1) {
    ...
    x && (e.visibleSlides.push(d), e.visibleSlidesIndexes.push(o)),
      fe(d, x, t.slideVisibleClass),
      fe(d, g, t.slideFullyVisibleClass),
      (d.progress = n ? -f : f),
...
function Ke() {
  ...
  o &&
    (l ||
      ((c = ke(o, `.${t.slideClass}, swiper-slide`)[0]),
      t.loop && !c && (c = e[0]),
      (d = Ge(o, `.${t.slideClass}, swiper-slide`)[0]),
      t.loop && !d === 0 && (d = e[e.length - 1]))),
    e.forEach((f) => {
      Y(f, f === o, t.slideActiveClass),
        Y(f, f === c, t.slideNextClass),
        Y(f, f === d, t.slidePrevClass);
    }),
    i.emitSlidesClasses();
}
const H = (i, e) => {
...
function wt(i) {
  ...
  const n = () => {
    ...
    d = (c) => {
      for (let f = 0; f < c; f += 1) {
        const p = e.isElement
          ? te("swiper-slide", [t.slideBlankClass])
          : te("div", [t.slideClass, t.slideBlankClass]);
        e.slidesEl.append(p);
      }
    };
  if (a) {
...
function St(i) {
  ...
  const w = b ? Math.ceil(d.length / u.grid.rows) : d.length,
    P = (b ? d[r].column : r) + (m && typeof n > "u" ? -g / 2 + 0.5 : 0);
  if (P < v) {
    C = Math.max(v - P, x);
...
function Mt(i) {
  ...
  let o = s.target;
  if (
    (r.touchEventsTarget === "wrapper" && !e.wrapperEl.contains(o)) ||
...
function Ct(i) {
  ...
  if (s.type === "touchend" || s.type === "touchcancel") {
    if (
      ((n = [...s.changedTouches].filter((T) => T.identifier === t.touchId)[0]),
  ...
  for (
    ...
    typeof d[T + M] < "u"
      ? (m || (u >= d[T] && u < d[T + M])) && ((g = T), (x = d[T + M] - d[T]))
      : (m || u >= d[T]) && ((g = T), (x = d[d.length - 1] - d[d.length - 2]));
  }
  let v = null,
    b = null;
  l.rewind &&
  ...
  if (p > l.longSwipesMs) {
    ...
    e.swipeDirection === "next" &&
      (h >= l.longSwipesRatio
        ? e.slideTo(l.rewind && e.isEnd ? v : g + S)
        : e.slideTo(g)),
    ...
    (s.target === e.navigation.nextEl || s.target === e.navigation.prevEl)
      ? s.target === e.navigation.nextEl
        ? e.slideTo(g + S)
        : e.slideTo(g)
      : (e.swipeDirection === "next" && e.slideTo(v !== null ? v : g + S),
...
function Gt() {
  ...
  (i.onTouchStart = Mt.bind(i)),
    ...
    e.cssMode && (i.onScroll = Ot.bind(i)),
    (i.onClick = Lt.bind(i)),
    (i.onLoad = zt.bind(i)),
    xe(i, "on");
}
...
class A {
  ...
  mount(e) {
    ...
    return (
      !l &&
        ...
        ((l = te("div", t.params.wrapperClass)),
        s.append(l),
  ...
  static use(e) {
    return Array.isArray(e)
      ? (e.forEach((t) => A.installModule(t)), A)
      : (A.installModule(e), A);
  }
}
...
ge.forEach((i, e) => {
  ...
  const n = () => {
    (J[e] = t.clientHeight),
      (s.style.height = (i.classList.contains("open") ? J[e] : 0) + "px");
  };
    ...
    i.addEventListener("click", () => {
      i.classList.toggle("open"),
        ge.forEach((r) => {
          ...
          r !== i && r.classList.remove("open"),
            (l.style.height = (r.classList.contains("open") ? J[e] : 0) + "px");
        });
    });
});
try {
  ...
  const n = () => {
    (s = t.clientHeight),
      i.classList.contains("open") && (s.style.height = s + "px");
  };
  window.addEventListener("resize", n),
    e.addEventListener("click", () => {
      i.classList.toggle("open"),
        e.classList.add("hide"),
        i.classList.contains("open") && (i.style.height = s + "px");
    });
} catch (i) {
  // console.log(i)
}
  ...
  console.log("!"),
    ...
    (document.documentElement.style["overflow-y"] =
      document.documentElement.style["overflow-y"] === "hidden"
        ? "initial"
        : "hidden"),
    Z.querySelectorAll("a").forEach((i) => {
      i.addEventListener("click", () => {
